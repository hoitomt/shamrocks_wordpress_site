...
function generate_right_sidebar_classes( $classes )
{
	...
	$right_sidebar_tablet_width = apply_filters( 'generate_right_sidebar_tablet_width', '25' );
	$left_sidebar_tablet_width = apply_filters( 'generate_left_sidebar_tablet_width', '25' );
